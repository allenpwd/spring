...
public class SpringTest {
    ...
    /**
     * 上下文
     * （2）若没有指定ContextConfiguration的classes，{@link org.springframework.test.context.support.AnnotationConfigContextLoader} 和 {@link org.springframework.test.context.web.AnnotationConfigWebContextLoader}
     * 将检测符合配置类实现要求的测试类的所有静态嵌套类
     */
//    @Configuration
//    static class MyTest {
